# Agriculture-Irrigation-Without-Arduino-
A low-cost soil moisture-based irrigation system without microcontroller that automatically controls water pump operation for efficient watering.
## Project Overview
This project is an automatic agriculture irrigation system without using Arduino or any microcontroller.
...
⚡ 5V Single Channel Relay Module – Acts as switch to control water pump
💧 Mini DC Water Pump – Pumps water to plants automatically
🔋 3.7V (18650) Li-ion Battery – Power source for the circuit
🔋 18650 Battery Holder – Holds battery safely
